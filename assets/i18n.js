...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      hist_brands: "Brands",
      hist_colProduct: "Product",
      hist_colBrand: "Brand",
      hist_colSite: "Site",
      hist_colConfidence: "Confidence",
      hist_colChecks: "Checks",
      hist_colLast: "Last checked",
      hist_allSites: "All sites",
      hist_allCountries: "All countries",
      hist_allOwners: "All owner countries",
      hist_noMatches: "No rows match these filters.",
    ...
    hist_brands: "Marken",
    hist_colProduct: "Produkt",
    hist_colBrand: "Marke",
    hist_colSite: "Website",
    hist_colConfidence: "Konfidenz",
    hist_colChecks: "Prüfungen",
    hist_colLast: "Zuletzt geprüft",
    hist_allSites: "Alle Websites",
    hist_allCountries: "Alle Länder",
    hist_allOwners: "Alle Eigentümerländer",
    hist_noMatches: "Keine Zeilen passen zu diesen Filtern.",
    ...
    hist_brands: "Marcas",
    hist_colProduct: "Producto",
    hist_colBrand: "Marca",
    hist_colSite: "Sitio",
    hist_colConfidence: "Confianza",
    hist_colChecks: "Comprobaciones",
    hist_colLast: "Última comprobación",
    hist_allSites: "Todos los sitios",
    hist_allCountries: "Todos los países",
    hist_allOwners: "Todos los países de propiedad",
    hist_noMatches: "Ninguna fila coincide con estos filtros.",
    ...
    hist_brands: "Marques",
    hist_colProduct: "Produit",
    hist_colBrand: "Marque",
    hist_colSite: "Site",
    hist_colConfidence: "Confiance",
    hist_colChecks: "Vérifications",
    hist_colLast: "Dernière vérification",
    hist_allSites: "Tous les sites",
    hist_allCountries: "Tous les pays",
    hist_allOwners: "Tous les pays du propriétaire",
    hist_noMatches: "Aucune ligne ne correspond à ces filtres.",
    ...
    hist_colBrand: "ブランド",
    hist_colSite: "サイト",
    hist_colConfidence: "確信度",
    hist_colChecks: "回数",
    hist_colLast: "最終確認",
    hist_allSites: "すべてのサイト",
    hist_allCountries: "すべての国",
    hist_allOwners: "すべての所有国",
    hist_noMatches: "この条件に一致する行はありません。",
    ...
    hist_colBrand: "品牌",
    hist_colSite: "网站",
    hist_colConfidence: "置信度",
    hist_colChecks: "查询次数",
    hist_colLast: "最近查询",
    hist_allSites: "全部网站",
    hist_allCountries: "全部国家",
    hist_allOwners: "全部所属国家",
    hist_noMatches: "没有符合这些筛选条件的记录。",
    ...
    hist_colBrand: "品牌",
    hist_colSite: "網站",
    hist_colConfidence: "信心度",
    hist_colChecks: "查詢次數",
    hist_colLast: "最近查詢",
    hist_allSites: "全部網站",
    hist_allCountries: "全部國家",
    hist_allOwners: "全部所屬國家",
    hist_noMatches: "沒有符合這些篩選條件的紀錄。",
